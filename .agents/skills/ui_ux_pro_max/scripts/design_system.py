...
class RecommendationBuilder(IRecommendationBuilder):
    ...
    def build_recommendation(
        ...
        product_results = self._extract_results(search_results.get("product", {}))
        ...
        best_product = product_results[0] if product_results else {}
        ...
        return {
            "category": best_product.get("Product Type", "General"),
            "pattern": {
...
def persist_design_system(
    ...
    """Top-level function to persist design system."""
    manager = PersistenceManager()
    return manager.persist_design_system(design_system, page, output_dir, page_query)

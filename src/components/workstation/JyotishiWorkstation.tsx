...
const styles = StyleSheet.create({
  ...
  dutyTitle: { ...typography.h3, color: '#EEF2FF', fontSize: 14, fontWeight: '800' },
  dutySub: { ...typography.tiny, color: '#A5B4FC', fontSize: 11, lineHeight: 15, fontWeight: '600' },
  ...
  statVal: { ...typography.display, fontSize: 20, color: '#EEF2FF', fontWeight: '900' },
  statLabel: { ...typography.tiny, color: '#A5B4FC', fontSize: 11, fontWeight: '600' },
  withdrawMiniBtn: {
  ...
  emptyTitle: { ...typography.h3, color: '#EEF2FF', fontWeight: '800' },
  emptySub: { ...typography.small, color: '#A5B4FC', textAlign: 'center', fontSize: 12 },
  ...
  clientName: { ...typography.h3, color: '#EEF2FF', fontSize: 15, fontWeight: '800' },
  clientTopic: { ...typography.small, color: colors.teal, fontSize: 12, fontWeight: '700' },
  clientBirthSub: { ...typography.tiny, color: '#A5B4FC', fontSize: 10.5, fontWeight: '600' },
  ratePill: {
  ...
  inspectKundliText: { ...typography.tiny, color: '#EEF2FF', fontWeight: '800', fontSize: 11 },
  ...
  toolTitle: { ...typography.h3, color: '#EEF2FF', fontSize: 13, fontWeight: '800' },
  toolSub: { ...typography.tiny, color: '#A5B4FC', fontSize: 10.5, fontWeight: '600' },
  ...
  modalTitle: { ...typography.h2, color: '#EEF2FF', fontSize: 18, fontWeight: '800' },
  modalSub: { ...typography.small, color: '#A5B4FC', fontSize: 12, fontWeight: '600' },
  ...
  rateInput: { flex: 1, fontSize: 22, color: '#EEF2FF', fontWeight: '900' },
  rateUnit: { fontSize: 14, color: '#A5B4FC', fontWeight: '700' },

  inspectHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  inspectTitle: { ...typography.h2, color: '#EEF2FF', fontSize: 17, fontWeight: '800' },
  inspectSub: { ...typography.small, color: '#A5B4FC', fontSize: 11.5, fontWeight: '600' },
  closeBtn: { padding: 6 },
  ...
  remedyTitle: { ...typography.h3, color: '#EEF2FF', fontSize: 13, fontWeight: '800' },
  remedyInput: {

...
const styles = StyleSheet.create({
  ...
  recomTitle: { ...typography.h3, color: colors.saffron, fontSize: 15, fontWeight: '800' },
  ...
  gemOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 },
  gemContent: {
    position: 'absolute',
    bottom: spacing.md,
    left: spacing.md,
  ...
  modalImage: { width: '100%', height: 160, borderRadius: radius.md, resizeMode: 'cover' },

...
const styles = StyleSheet.create({
  ...
  coreVal: { ...typography.display, fontSize: 36, color: colors.goldSoft, fontWeight: '900' },
  coreLabel: { ...typography.h3, fontSize: 13, color: '#EEF2FF', textAlign: 'center', fontWeight: '800' },
  coreSub: { ...typography.tiny, color: '#A5B4FC', fontSize: 10, textAlign: 'center', fontWeight: '600' },
  ...
  pastLifeTitle: { ...typography.tiny, color: colors.goldSoft, fontWeight: '800' },
  pastLifeRole: { ...typography.h2, color: '#EEF2FF', fontSize: 16, fontWeight: '800' },
  divider: { height: 1, backgroundColor: 'rgba(129, 140, 248, 0.2)', marginVertical: 4 },
  detailRow: { gap: 2 },
  detailLabel: { ...typography.tiny, color: colors.goldSoft, fontWeight: '800' },
  detailVal: { ...typography.small, color: '#EEF2FF', lineHeight: 18, fontWeight: '600' },

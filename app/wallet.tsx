...
export default function Wallet() {
  ...
  const handleVerify = async () => {
    ...
    if (!cleanUtr) {
      setVerifyError('Please enter the 12-digit Bank UTR / Reference Number from your payment receipt.');
      return;
    }
...
const styles = StyleSheet.create({
  ...
  methodLabel: { ...typography.body, color: '#EEF2FF', fontWeight: '800', fontSize: 14 },
  methodSub: { ...typography.tiny, color: '#A5B4FC', marginTop: 1, fontWeight: '600' },
  radio: {
    width: 20,
    height: 20,
    borderRadius: 10,
  ...
  upiAppLabel: { ...typography.small, color: '#EEF2FF', fontWeight: '800', fontSize: 13.5 },
  ...
  filterTabText: { ...typography.tiny, color: '#A5B4FC', fontWeight: '800', fontSize: 12 },
  ...
  modalTitle: { ...typography.h2, color: '#EEF2FF', textAlign: 'center', fontWeight: '900' },
  modalSub: { ...typography.tiny, color: '#A5B4FC', textAlign: 'center', fontWeight: '600' },
  verifyBox: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.sm,
  ...
  verifyBoxTitle: { ...typography.small, color: '#EEF2FF', fontWeight: '900' },
  verifyBoxSub: { ...typography.tiny, color: '#A5B4FC', marginTop: 2, fontWeight: '600' },
  utrSection: { gap: 4 },
  utrLabel: { ...typography.tiny, color: '#A5B4FC', fontWeight: '800' },
  utrInput: {
    backgroundColor: 'rgba(26, 33, 64, 0.85)',
    borderWidth: 1.5,
    borderColor: 'rgba(129, 140, 248, 0.35)',
  ...
  utrHint: { ...typography.tiny, color: '#818CF8', fontSize: 11, fontWeight: '600' },
  diagBox: {
  ...
  diagRow: { ...typography.tiny, color: '#A5B4FC', fontSize: 11.5, fontWeight: '600' },

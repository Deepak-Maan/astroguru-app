    ...
    <GradientBackground>
      <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
        ...
        <View style={styles.actions}>
          <LinearGradient
            colors={['rgba(10, 12, 22, 0.0)', 'rgba(10, 12, 22, 0.98)']}
          ...
          <Pressable
            ...
            style={({ pressed }) => [
              styles.mediaCallBtn,
              { borderColor: 'rgba(129, 140, 248, 0.45)', backgroundColor: 'rgba(99, 102, 241, 0.25)' },
              pressed && { transform: [{ translateY: 1.5 }], opacity: 0.85 },
            ]}
          >
            <Text style={{ fontSize: 15 }}>📹</Text>
            <Text style={[styles.mediaCallText, { color: '#EEF2FF' }]}>Video</Text>
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  statValue: { ...typography.h3, fontSize: 13.5, color: '#EEF2FF', fontWeight: '900' },
  statLabel: { ...typography.tiny, fontSize: 9.5, color: '#A5B4FC', fontWeight: '700' },

  compactCard: { paddingHorizontal: 16, paddingVertical: 14 },
  sectionTitle: { ...typography.h3, fontSize: 15, color: '#EEF2FF', fontWeight: '900', marginBottom: 6 },

  about: { ...typography.body, color: '#A5B4FC', lineHeight: 18, fontWeight: '600', fontSize: 13 },
  subLabel: { ...typography.tiny, color: '#A5B4FC', marginTop: 10, marginBottom: 4, fontWeight: '800', fontSize: 11 },
  ...
  price: { ...typography.display, fontSize: 24, color: '#FCD34D', fontWeight: '900' },
  perMin: { ...typography.body, color: '#A5B4FC', fontWeight: '700', fontSize: 13.5 },
  priceSub: { ...typography.tiny, color: '#A5B4FC', marginTop: 2, fontWeight: '600', fontSize: 11 },
  ...
  affordText: { ...typography.small, color: '#EEF2FF', lineHeight: 15, flex: 1, fontWeight: '700', fontSize: 11.5 },

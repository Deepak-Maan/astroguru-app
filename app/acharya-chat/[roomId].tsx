...
const styles = StyleSheet.create({
  ...
  backIcon: { fontSize: 22, color: '#EEF2FF', lineHeight: 30, marginLeft: -2, fontWeight: '700' },
  hName: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 1 },
  statusDot: { width: 7, height: 7, borderRadius: 4 },
  hMeta: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },
  headerActionBtn: {
    width: 34, height: 34,
    borderRadius: 17,
    backgroundColor: 'rgba(99, 102, 241, 0.25)',
  ...
  earnedVal: { color: '#34D399', fontWeight: '900', fontSize: 13 },
  earnedSub: { color: '#34D399', fontWeight: '700', fontSize: 9, opacity: 0.8 },
  ...
  stripText: { fontSize: 11, color: '#A5B4FC', fontWeight: '600', flex: 1 },
  ...
  sysText: { fontSize: 11, color: '#A5B4FC', fontWeight: '700', textAlign: 'center' },
  ...
  endedBarText: { fontSize: 12, fontWeight: '700', color: '#A5B4FC' },
});
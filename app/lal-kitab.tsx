...
const styles = StyleSheet.create({
  ...
  tabBtnText: { ...typography.tiny, color: '#A5B4FC', fontWeight: '800', fontSize: 12 },
  ...
  heroTitle: { ...typography.h3, color: '#FCD34D', fontSize: 16, fontWeight: '800' },
  heroSub: { ...typography.small, color: '#A5B4FC', marginTop: 2, lineHeight: 18, fontWeight: '600' },

  debtCard: { gap: spacing.xs },
  debtTitle: { ...typography.h3, color: '#EEF2FF', fontSize: 16, fontWeight: '800' },
  debtSanskrit: { ...typography.tiny, color: '#F59E0B', fontWeight: '700' },
  causeText: { ...typography.small, color: '#EEF2FF', marginTop: 4, lineHeight: 18 },

  symptomHeader: { ...typography.tiny, color: '#A5B4FC', fontWeight: '800', marginTop: spacing.xs },
  symptomItem: { ...typography.small, color: '#EEF2FF', lineHeight: 18 },
  ...
  remedyTitle: { ...typography.tiny, color: '#F59E0B', fontWeight: '800' },
  remedyText: { ...typography.small, color: '#EEF2FF', lineHeight: 19, fontWeight: '600' },
  ...
  th: { ...typography.tiny, color: '#818CF8', fontWeight: '800', fontSize: 11 },
  tableRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.md,
  ...
  td: { ...typography.small, color: '#EEF2FF' },
  tdStrong: { ...typography.small, color: '#EEF2FF', fontWeight: '700' },
  tdFaint: { ...typography.tiny, color: '#A5B4FC', fontStyle: 'italic' },

  /* Tracker */
  progressBox: { gap: 4, marginVertical: spacing.xs },
  progressText: { ...typography.small, color: '#EEF2FF', fontWeight: '700' },
  progressPct: { ...typography.small, color: '#FCD34D', fontWeight: '900' },
  track: { height: 10, backgroundColor: 'rgba(26, 33, 64, 0.85)', borderRadius: 5, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)' },
  bar: { height: '100%', backgroundColor: '#F59E0B', borderRadius: 5 },

  gridHeader: { ...typography.tiny, color: '#A5B4FC', fontWeight: '700', marginTop: spacing.sm },
  ...
  dayCellText: { ...typography.small, color: '#EEF2FF', fontWeight: '800' },

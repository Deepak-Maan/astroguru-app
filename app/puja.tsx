...
const styles = StyleSheet.create({
  ...
  modalBody: { gap: 4 },
  modalPujaName: { ...typography.h3, color: '#EEF2FF', fontSize: 16, fontWeight: '800' },
  modalTemple: { ...typography.tiny, color: '#A5B4FC' },
  modalPrice: { ...typography.h2, color: colors.goldSoft, marginTop: 4, fontWeight: '800' },
  addressLabel: { ...typography.tiny, color: '#A5B4FC', marginTop: spacing.md, fontWeight: '700' },
  addressInput: {

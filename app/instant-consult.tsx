...
const styles = StyleSheet.create({
  ...
  astroCardSelected: { borderColor: '#F59E0B', borderWidth: 2, backgroundColor: 'rgba(245, 158, 11, 0.12)' },
  astroAvatar: { width: 56, height: 56, borderRadius: 28 },
  astroName: { ...typography.h3, color: '#EEF2FF', fontSize: 16, fontWeight: '800' },
  astroSpecs: { ...typography.tiny, color: '#A5B4FC', fontWeight: '700' },
  astroPrice: { ...typography.h3, color: '#FCD34D', fontSize: 15, fontWeight: '800', marginTop: 2 },
});

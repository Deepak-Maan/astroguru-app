...
const styles = StyleSheet.create({
  ...
  signGlyph: { fontSize: 24, color: '#B8902A' },
  signName: { ...typography.tiny, fontSize: 10, color: '#0F172A', fontWeight: '700' },
  yourDot: {
    position: 'absolute',
    top: 5,
    right: 5,
  ...
  periodText: { ...typography.small, color: '#64748B', fontWeight: '700', fontSize: 13 },
  periodTextActive: { color: '#0F172A', fontWeight: '900' },
  ...
  readingGlyph: { fontSize: 28, color: '#B8902A' },
  readingSign: {
    ...typography.h2,
    color: '#0F172A',
    fontWeight: '800',
  ...
  readingMeta: { ...typography.tiny, color: '#64748B', marginTop: 2, textTransform: 'capitalize', fontWeight: '600' },
  moodCircle: {
    width: 48,
    height: 48,
    borderRadius: 24,
  ...
  moodValue: { ...typography.h3, fontSize: 15, color: '#0D9488', lineHeight: 18, fontWeight: '800' },
  moodPct: { ...typography.tiny, fontSize: 9.5, color: '#0D9488', fontWeight: '800' },

  summary: { ...typography.body, color: '#0F172A', lineHeight: 22, fontWeight: '500' },
  moodBarTrack: {
    height: 8,
    borderRadius: 4,
  ...
  moodCaption: { ...typography.tiny, color: '#64748B', marginTop: 6, fontWeight: '700' },
  ...
  areaTitle: { ...typography.h3, fontSize: 15, color: '#0F172A', fontWeight: '800' },
  areaText: { ...typography.small, color: '#475569', marginTop: 4, lineHeight: 19, fontWeight: '500' },
  ...
  luckyLabel: { ...typography.tiny, color: '#64748B', fontWeight: '700' },

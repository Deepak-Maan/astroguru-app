...
const styles = StyleSheet.create({
  ...
  tabIcon: { fontSize: 13 },
  tabText: { ...typography.small, color: '#64748B', fontWeight: '700', fontSize: 13, lineHeight: 18 },
  ...
  chartTitle: { ...typography.h2, color: '#0F172A', fontWeight: '800' },
  chartSub: { ...typography.small, color: '#64748B', marginTop: 2, fontWeight: '600' },
  ...
  detailLabel: { ...typography.small, color: '#475569', flex: 1, fontWeight: '600' },
  detailValue: { ...typography.h3, fontSize: 15, color: '#B8902A', textAlign: 'right', fontWeight: '800' },
  detailSub: { ...typography.tiny, color: '#64748B', marginTop: 2, textAlign: 'right', fontWeight: '600' },
  ...
  doshaTitle: { ...typography.h3, fontSize: 15, color: '#0F172A', fontWeight: '800' },
  doshaText: { ...typography.small, color: '#475569', marginTop: 5, lineHeight: 19, fontWeight: '600' },
  ...
  th: { ...typography.tiny, color: '#B8902A', textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: '800' },
  tableRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.md,
  ...
  td: { ...typography.small, color: '#0F172A', fontWeight: '600' },
  tdStrong: { ...typography.small, color: '#0F172A', fontWeight: '800' },
  tdSub: { ...typography.tiny, color: '#64748B', marginTop: 2, fontWeight: '600' },
  ...
  houseNumText: { ...typography.h3, fontSize: 14, color: '#B8902A', fontWeight: '900' },
  houseRashi: { ...typography.h3, fontSize: 15, color: '#0F172A', fontWeight: '800' },
  houseLord: { ...typography.tiny, color: '#64748B', marginTop: 3, fontWeight: '600' },
  occupants: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs, marginTop: spacing.sm },
  empty: { ...typography.tiny, color: '#94A3B8', fontStyle: 'italic', marginTop: spacing.sm },
  ...
  dashaName: { ...typography.h3, fontSize: 14, color: '#0F172A', fontWeight: '800' },
  dashaYears: { ...typography.tiny, color: '#64748B', marginTop: 2, fontWeight: '600' },
  dashaDate: { ...typography.small, color: '#B8902A', fontWeight: '800', fontSize: 12 },
  ...
  matchScoreNum: { fontSize: 52, fontWeight: '900', color: '#B45309' },
  matchScoreLabel: { ...typography.h3, color: '#B45309', marginTop: 4, fontWeight: '800' },
  matchVerdict: { ...typography.small, color: '#475569', textAlign: 'center', marginTop: spacing.sm, lineHeight: 18, paddingHorizontal: spacing.lg, fontWeight: '600' },

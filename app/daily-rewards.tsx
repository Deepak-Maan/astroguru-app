...
const styles = StyleSheet.create({
  ...
  backIcon: { fontSize: 22, color: '#EEF2FF', fontWeight: '700', marginLeft: -2 },
  title: { ...typography.h3, fontSize: 16, fontWeight: '900', color: '#EEF2FF' },
  subTitle: { ...typography.tiny, color: '#A5B4FC', fontSize: 10.5, fontWeight: '600' },
  coinsBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(99, 102, 241, 0.25)',
  ...
  coinsText: { ...typography.tiny, fontWeight: '900', color: '#FCD34D' },
  ...
  addRemedyBtnText: { color: '#EEF2FF', fontSize: 11, fontWeight: '800' },
  remedyItem: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(26, 33, 64, 0.78)',
  ...
  remedyTitle: { fontSize: 12.5, fontWeight: '700', color: '#EEF2FF' },
  remedyTitleDone: { textDecorationLine: 'line-through', color: '#64748B' },
  remedyTiming: { fontSize: 10, color: '#A5B4FC', marginTop: 2, fontWeight: '600' },
  ...
  prizeTitle: { ...typography.h2, fontSize: 20, fontWeight: '900', color: '#EEF2FF', marginTop: 8 },
  prizeSub: { fontSize: 12, color: '#A5B4FC', marginTop: 4 },
  prizeBadge: {
  ...
  prizeBadgeText: { fontSize: 16, fontWeight: '900', color: colors.goldSoft },
  prizeNote: { fontSize: 11, color: '#A5B4FC', marginBottom: 16 },
  prizeCloseBtn: {
    width: '100%',
    paddingVertical: 12,
    borderRadius: radius.pill,
  ...
  addModalTitle: { ...typography.h3, fontSize: 16, fontWeight: '900', color: '#EEF2FF', marginBottom: 12 },
  addInput: {
    backgroundColor: 'rgba(26, 33, 64, 0.85)',
    borderWidth: 1.5,

...
const styles = StyleSheet.create({
  ...
  tabText: { ...typography.tiny, color: '#A5B4FC', fontWeight: '700' },
  ...
  sunIcon: { fontSize: 22 },
  sunLabel: { ...typography.tiny, color: '#A5B4FC', marginTop: 4 },
  sunTime: { ...typography.small, color: '#EEF2FF', fontWeight: '800', marginTop: 2 },

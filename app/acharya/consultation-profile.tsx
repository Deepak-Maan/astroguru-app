...
const styles = StyleSheet.create({
  ...
  visLabel: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  visSub: { fontSize: 12, color: '#A5B4FC', fontWeight: '600', marginTop: 2 },
  section: { gap: 6 },
  label: { fontSize: 13, fontWeight: '700', color: '#A5B4FC', marginBottom: 2 },
  input: {
    backgroundColor: 'rgba(10, 12, 22, 0.6)', borderRadius: radius.md, borderWidth: 1,
    borderColor: 'rgba(129, 140, 248, 0.3)', padding: 12, fontSize: 15,
    color: '#EEF2FF', fontWeight: '500',
  },
  textArea: { minHeight: 110, paddingTop: 12 },
  charCount: { fontSize: 11, color: '#A5B4FC', alignSelf: 'flex-end' },

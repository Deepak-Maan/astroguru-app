...
const styles = StyleSheet.create({
  ...
  infoSub: { fontSize: 12, color: '#A5B4FC', fontWeight: '500', lineHeight: 18 },
  certCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg, padding: spacing.md,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', borderLeftWidth: 4, gap: 8,
  },
  certName: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  certBody: { fontSize: 13, color: '#A5B4FC', fontWeight: '600' },
  certYear: { fontSize: 12, color: '#A5B4FC', fontWeight: '600' },
  ...
  addBtn: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg, padding: 16, alignItems: 'center',
    borderWidth: 2, borderColor: colors.teal, borderStyle: 'dashed',
  },
  addBtnText: { color: colors.teal, fontWeight: '800', fontSize: 15 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(5,7,15,0.75)', justifyContent: 'flex-end' },
  modalCard: {
    backgroundColor: '#11162B', borderTopLeftRadius: 24, borderTopRightRadius: 24,
    padding: spacing.lg, gap: spacing.sm, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  modalTitle: { fontSize: 18, fontWeight: '900', color: '#EEF2FF', marginBottom: 4 },
  modalInput: {
  ...
  cancelBtn: {
    flex: 1, padding: 14, borderRadius: radius.md, backgroundColor: 'rgba(26, 33, 64, 0.78)', alignItems: 'center',
  },
  cancelBtnText: { fontWeight: '700', color: '#A5B4FC' },
  confirmBtn: {

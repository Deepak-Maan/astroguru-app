...
const styles = StyleSheet.create({
  ...
  arrowBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(99, 102, 241, 0.2)', alignItems: 'center', justifyContent: 'center' },
  arrowText: { fontSize: 22, fontWeight: '800', color: '#EEF2FF', marginTop: -2 },
  monthText: { fontSize: 16, fontWeight: '800', color: '#EEF2FF' },
  growthBadge: {
    backgroundColor: 'rgba(5,150,105,0.2)', borderRadius: radius.pill, paddingVertical: 8, paddingHorizontal: 16,
    alignSelf: 'center', borderWidth: 1, borderColor: 'rgba(5,150,105,0.35)',
  },
  growthText: { color: colors.teal, fontWeight: '800', fontSize: 13 },
  metricsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  metricCard: {
    flex: 1, minWidth: '45%', backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.md, padding: spacing.md, gap: 4,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  metricLabel: { fontSize: 12, color: '#A5B4FC', fontWeight: '600' },
  metricVal: { fontSize: 18, fontWeight: '900', color: '#EEF2FF' },
  ...
  barVal: { fontSize: 10, fontWeight: '700', color: '#A5B4FC' },
  barTrack: { width: 24, height: 100, backgroundColor: 'rgba(15, 23, 42, 0.6)', borderRadius: 12, justifyContent: 'flex-end', overflow: 'hidden' },
  barFill: { width: '100%', backgroundColor: colors.teal, borderRadius: 12 },
  barLabel: { fontSize: 11, fontWeight: '700', color: '#EEF2FF' },
  logCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', overflow: 'hidden',
  },
  txRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: spacing.md },
  seekerName: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  txMeta: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },

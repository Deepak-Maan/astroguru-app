...
const styles = StyleSheet.create({
  ...
  summaryCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.xl, padding: spacing.lg,
    alignItems: 'center', gap: 8,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  ratingBig: { flexDirection: 'row', alignItems: 'flex-end', gap: 4 },
  ratingNum: { fontSize: 48, fontWeight: '900', color: '#EEF2FF', lineHeight: 54 },
  ratingStar: { fontSize: 36, color: '#FCD34D', lineHeight: 50 },
  ratingTotal: { fontSize: 13, color: '#A5B4FC', fontWeight: '600' },
  breakdown: { width: '100%', gap: 6, marginTop: 8 },
  breakdownRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  breakdownStarLabel: { fontSize: 12, color: '#A5B4FC', fontWeight: '700', width: 22 },
  barTrack: { flex: 1, height: 8, backgroundColor: 'rgba(15, 23, 42, 0.6)', borderRadius: 4, overflow: 'hidden' },
  barFill: { height: '100%', backgroundColor: '#06B6D4', borderRadius: 4 },
  breakdownPct: { fontSize: 12, color: '#A5B4FC', fontWeight: '700', width: 30, textAlign: 'right' },
  filterRow: { flexDirection: 'row', gap: spacing.sm },
  filterTab: {
    flex: 1, paddingVertical: 9, borderRadius: radius.pill, backgroundColor: 'rgba(26, 33, 64, 0.78)',
    alignItems: 'center', borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  filterTabActive: { backgroundColor: colors.teal, borderColor: colors.teal },
  filterTabText: { fontSize: 13, fontWeight: '700', color: '#A5B4FC' },
  ...
  reviewerName: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  verifiedBadge: { backgroundColor: 'rgba(5,150,105,0.2)', borderRadius: radius.pill, paddingHorizontal: 7, paddingVertical: 2 },
  verifiedBadgeText: { fontSize: 10, color: colors.teal, fontWeight: '800' },
  reviewDate: { fontSize: 11, color: '#A5B4FC' },
  reviewText: { fontSize: 13, color: '#EEF2FF', lineHeight: 20, fontWeight: '500' },
});

...
const styles = StyleSheet.create({
  ...
  masterLabel: { fontSize: 14, fontWeight: '700', color: '#EEF2FF' },
  masterSub: { fontSize: 12, color: '#A5B4FC', fontWeight: '600', marginTop: 2 },
  sectionTitle: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  dayCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.md, padding: spacing.md, gap: spacing.sm,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  dayHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  dayLabelBox: {
    width: 48, height: 34, borderRadius: radius.sm, backgroundColor: 'rgba(99, 102, 241, 0.15)',
    alignItems: 'center', justifyContent: 'center',
  },
  dayLabel: { fontSize: 13, fontWeight: '800', color: '#EEF2FF' },
  timeRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  timeControl: { flex: 1, gap: 4 },
  timeLabel: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },
  timeStepper: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: 'rgba(10, 12, 22, 0.6)', borderRadius: radius.md, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
    overflow: 'hidden',
  },
  stepBtn: { paddingHorizontal: 12, paddingVertical: 8, backgroundColor: 'rgba(99, 102, 241, 0.2)' },
  stepBtnText: { fontSize: 18, fontWeight: '800', color: '#EEF2FF', lineHeight: 22 },
  timeValue: { flex: 1, textAlign: 'center', fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  timeDash: { fontSize: 16, color: '#A5B4FC', fontWeight: '700', marginTop: 18 },
  ...
  optionBtnText: { fontSize: 14, fontWeight: '800', color: '#A5B4FC' },

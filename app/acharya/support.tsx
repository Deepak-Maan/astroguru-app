...
const styles = StyleSheet.create({
  ...
  searchCard: { backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', padding: 4 },
  searchInput: { paddingHorizontal: 16, paddingVertical: 12, fontSize: 14, color: '#EEF2FF', fontWeight: '500' },
  contactRow: { flexDirection: 'row', gap: spacing.sm },
  contactCard: {
    flex: 1, backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.md, padding: spacing.md, alignItems: 'center', gap: 4,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  contactIcon: { fontSize: 24 },
  contactTitle: { fontSize: 13, fontWeight: '800', color: '#EEF2FF' },
  contactSub: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },
  sectionTitle: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  faqList: { gap: spacing.sm },
  faqItem: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.md, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', overflow: 'hidden',
  },
  faqHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: spacing.md, gap: 8 },
  faqQuestion: { fontSize: 13, fontWeight: '800', color: '#EEF2FF', flex: 1 },
  faqChevron: { fontSize: 11, color: '#A5B4FC' },
  faqBody: { paddingHorizontal: spacing.md, paddingBottom: spacing.md, borderTopWidth: 1, borderTopColor: 'rgba(129, 140, 248, 0.2)', paddingTop: 10 },
  faqAnswer: { fontSize: 13, color: '#A5B4FC', lineHeight: 19, fontWeight: '500' },
  ticketCard: {

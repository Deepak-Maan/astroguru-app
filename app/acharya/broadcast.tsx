...
const styles = StyleSheet.create({
  ...
  composeInput: {
    ...
    padding: 12, fontSize: 14, color: '#EEF2FF', minHeight: 120,
  },
  charCounter: { fontSize: 11, color: '#A5B4FC', alignSelf: 'flex-end', fontWeight: '600' },
  section: { gap: spacing.sm },
  sectionLabel: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip: {
    paddingHorizontal: 14, paddingVertical: 8, borderRadius: radius.pill,
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  chipSelected: { backgroundColor: colors.teal, borderColor: colors.teal },
  chipText: { fontSize: 13, fontWeight: '700', color: '#A5B4FC' },
  chipTextSelected: { color: '#FFFFFF' },
  scheduleBtn: {
    flex: 1, padding: 12, borderRadius: radius.md, borderWidth: 1,
    borderColor: 'rgba(129, 140, 248, 0.3)', alignItems: 'center', backgroundColor: 'rgba(26, 33, 64, 0.78)',
  },
  scheduleBtnActive: { backgroundColor: colors.teal, borderColor: colors.teal },
  scheduleBtnText: { fontSize: 13, fontWeight: '700', color: '#A5B4FC' },
  input: {
  ...
  pastTitle: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  pastCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.md, padding: spacing.md,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)',
  },
  pastMessage: { fontSize: 13, color: '#EEF2FF', lineHeight: 19, fontWeight: '500' },
  pastDate: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },

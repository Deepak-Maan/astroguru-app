...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: '800', color: '#EEF2FF' },
  courseCard: {
  ...
  courseIconBox: {
    width: 44, height: 44, borderRadius: 12, backgroundColor: 'rgba(99, 102, 241, 0.15)',
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.25)',
  },
  courseIcon: { fontSize: 22 },
  courseTitle: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  courseMeta: { fontSize: 12, color: '#A5B4FC', fontWeight: '600' },
  completedBadge: { width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(5,150,105,0.2)', alignItems: 'center', justifyContent: 'center' },
  completedBadgeText: { fontSize: 16 },
  progressTrack: { height: 8, backgroundColor: 'rgba(15, 23, 42, 0.6)', borderRadius: 4, overflow: 'hidden' },
  ...
  resourcesCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', overflow: 'hidden',
  },
  resourceRow: { flexDirection: 'row', alignItems: 'center', padding: spacing.md, gap: spacing.sm },
  resourceIcon: { fontSize: 22 },
  resourceTitle: { fontSize: 14, fontWeight: '700', color: '#EEF2FF' },
  resourceSize: { fontSize: 11, color: '#A5B4FC', fontWeight: '600' },
  downloadIcon: { fontSize: 18 },
  webinarCard: {
    backgroundColor: 'rgba(26, 33, 64, 0.78)', borderRadius: radius.lg, padding: spacing.md,
    borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.3)', borderLeftWidth: 4, borderLeftColor: '#818CF8',
    gap: 3,
  },
  webinarTitle: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  webinarMeta: { fontSize: 12, color: '#A5B4FC', fontWeight: '600' },
  webinarHost: { fontSize: 12, color: '#A5B4FC', fontWeight: '600' },
  webinarSeats: { fontSize: 12, color: '#A5B4FC', fontWeight: '700' },
  registerBtn: { backgroundColor: 'rgba(99,102,241,0.25)', borderRadius: radius.pill, paddingHorizontal: 14, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(129, 140, 248, 0.4)' },
  registerBtnText: { color: '#EEF2FF', fontWeight: '800', fontSize: 13 },
});

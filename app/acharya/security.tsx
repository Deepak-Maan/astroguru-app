...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 14, fontWeight: '700', color: '#EEF2FF' },
  cardSub: { fontSize: 12, color: '#A5B4FC', fontWeight: '500', marginTop: 2 },
  ...
  sessionName: { fontSize: 14, fontWeight: '800', color: '#EEF2FF' },
  sessionMeta: { fontSize: 11, color: '#A5B4FC', fontWeight: '600', marginTop: 2 },
  currentBadge: { backgroundColor: 'rgba(5,150,105,0.2)', borderRadius: radius.pill, paddingHorizontal: 8, paddingVertical: 3 },
  ...
  radioCircle: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: 'rgba(129, 140, 248, 0.4)', alignItems: 'center', justifyContent: 'center' },
  radioCircleActive: { borderColor: colors.teal },
  radioInner: { width: 10, height: 10, borderRadius: 5, backgroundColor: colors.teal },
  radioText: { fontSize: 13, color: '#EEF2FF', fontWeight: '600' },
  switchRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  switchLabel: { fontSize: 13, color: '#EEF2FF', fontWeight: '600', flex: 1 },
});

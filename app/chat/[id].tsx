...
const styles = StyleSheet.create({
  header: {
    ...
    borderBottomColor: 'rgba(129, 140, 248, 0.22)',
    shadowColor: '#6366F1',
  ...
  hName: { ...typography.h3, fontSize: 15.5, color: '#EEF2FF', fontWeight: '900' },
  ...
  walletVal: { ...typography.h3, fontSize: 13, color: '#38BDF8', textAlign: 'center', fontWeight: '900' },
  ...
  callName: { ...typography.h1, fontSize: 22, color: '#EEF2FF', textAlign: 'center', fontWeight: '900' },
  ...
  promptText: { ...typography.tiny, color: '#FCD34D', fontWeight: '800', fontSize: 11.5 },
  ...
  rechargeCard: {
    backgroundColor: 'rgba(19, 23, 46, 0.98)',

...
const styles = StyleSheet.create({
  ...
  heroTitle: { ...typography.display, fontSize: 26, color: colors.goldSoft, textAlign: 'center', fontWeight: '800' },
  heroSub: { ...typography.small, color: '#A5B4FC', textAlign: 'center', lineHeight: 18, fontWeight: '600' },
  activeBadge: {
  ...
  planCardActive: { borderColor: '#818CF8', borderWidth: 2, backgroundColor: 'rgba(99, 102, 241, 0.15)' },
  savingsTag: {
    position: 'absolute',
    top: 0,
    right: 0,
  ...
  planName: { ...typography.h3, fontSize: 14, color: '#EEF2FF', marginTop: spacing.xs, fontWeight: '800' },
  planPrice: { ...typography.h2, color: colors.goldSoft, marginTop: 2, fontWeight: '800' },
  planPeriod: { ...typography.tiny, color: '#A5B4FC', fontSize: 11, fontWeight: '600' },
  ...
  pmRowActive: { borderColor: '#818CF8', backgroundColor: 'rgba(99, 102, 241, 0.18)' },
  pmLabel: { ...typography.small, color: '#EEF2FF', fontWeight: '700' },
  pmRec: { ...typography.tiny, color: colors.goldSoft, fontSize: 10, fontWeight: '800' },
  ...
  radioActive: { borderColor: colors.goldSoft },
  radioInner: { width: 10, height: 10, borderRadius: 5, backgroundColor: colors.goldSoft },
  ...
  checkIcon: { color: colors.goldSoft, fontSize: 12, fontWeight: '900' },
  perkText: { ...typography.small, color: '#EEF2FF', flex: 1, fontSize: 13.5, fontWeight: '600' },

  mockNote: { ...typography.tiny, color: '#818CF8', textAlign: 'center' },
  ...
  modalText: { ...typography.body, color: '#EEF2FF', textAlign: 'center', fontSize: 15, fontWeight: '600' },
  ...
  receiptLine: { ...typography.small, color: '#EEF2FF', fontSize: 13, fontWeight: '600' },
});

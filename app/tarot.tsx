...
const styles = StyleSheet.create({
  ...
  priceTitle: { ...typography.small, color: '#EEF2FF', fontWeight: '800' },
  priceSub: { ...typography.tiny, color: '#A5B4FC', marginTop: 1, fontWeight: '600' },

  instruction: { ...typography.small, color: '#A5B4FC', textAlign: 'center', fontWeight: '600' },

  cardsRow: { gap: spacing.lg },
  cardCol: { gap: spacing.xs },
  posTitle: { ...typography.h3, color: colors.goldSoft, textAlign: 'center', marginBottom: spacing.xs, fontWeight: '800' },
  ...
  readHeading: { ...typography.tiny, color: '#818CF8', fontWeight: '700', marginTop: spacing.md },

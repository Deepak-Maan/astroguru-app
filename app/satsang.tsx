...
const styles = StyleSheet.create({
  ...
  offeringName: { ...typography.tiny, color: '#EEF2FF', fontWeight: '700', textAlign: 'center' },
  ...
  successText: { ...typography.small, color: '#34D399', fontWeight: '800' },
  ...
  msgUser: { ...typography.tiny, color: '#F59E0B', fontWeight: '800' },
  msgText: { ...typography.small, color: '#EEF2FF', flex: 1 },
  msgTime: { ...typography.tiny, color: '#A5B4FC', fontSize: 9 },

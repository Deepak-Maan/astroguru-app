...
const styles = StyleSheet.create({
  ...
  microLabel: { ...typography.tiny, color: '#818CF8', fontWeight: '600' },
  ...
  listName: { ...typography.body, color: '#EEF2FF', fontWeight: '700' },
  listState: { ...typography.tiny, color: '#A5B4FC', marginTop: 1 },
  noResult: { ...typography.small, color: '#818CF8', padding: spacing.md },
  selectedCity: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.md,
  ...
  selectedCityName: { ...typography.body, color: '#EEF2FF', fontWeight: '800' },
  selectedCityMeta: { ...typography.tiny, color: '#A5B4FC', marginTop: 2 },
  changeText: { ...typography.small, color: colors.goldSoft, fontWeight: '800' },
  ...
  checkboxText: { ...typography.tiny, color: '#A5B4FC', flex: 1 },

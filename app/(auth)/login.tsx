...
const styles = StyleSheet.create({
  ...
  tabContainer: {
    flexDirection: 'row',
    backgroundColor: 'rgba(20, 26, 56, 0.95)',
    borderBottomWidth: 1,
  ...
  tabButtonActive: {
    backgroundColor: 'rgba(34, 43, 80, 0.9)',
    borderTopWidth: 1.5,
    borderLeftWidth: 1.2,
  ...
  googleBtnText: { ...typography.body, color: '#EEF2FF', fontWeight: '800', fontSize: 15 },
  ...
  dividerLine: { flex: 1, height: 1, backgroundColor: 'rgba(129, 140, 248, 0.25)' },
  dividerText: { ...typography.tiny, color: '#818CF8', fontWeight: '700' },
  ...
  countryCodeText: { ...typography.body, color: '#EEF2FF', fontWeight: '800', fontSize: 14 },
  phoneInput: {
    flex: 1,
    backgroundColor: 'rgba(26, 33, 64, 0.85)',
    borderWidth: 1.5,
  ...
  demoChipText: { ...typography.tiny, color: '#EEF2FF', fontWeight: '700' },

...
const styles = StyleSheet.create({
  ...
  logoInnerCircle: { width: '100%', height: '100%', borderRadius: 36, backgroundColor: '#11162B', alignItems: 'center', justifyContent: 'center' },
  badgePill: {
  ...
  brandTitle: { ...typography.display, fontSize: 30, color: '#EEF2FF', fontWeight: '800' },
  brandSubtitle: { ...typography.small, color: '#A5B4FC', textAlign: 'center', fontWeight: '600' },
  card: {
  ...
  label: { ...typography.tiny, color: '#A5B4FC', fontWeight: '800', letterSpacing: 0.6 },
  input: {
  ...
  errorText: { ...typography.small, color: '#FDA4AF', textAlign: 'center', fontWeight: '700' },
  ...
  footerText: { ...typography.small, color: '#A5B4FC', fontWeight: '600' },
  footerLink: { ...typography.small, color: '#818CF8', fontWeight: '800' },
});

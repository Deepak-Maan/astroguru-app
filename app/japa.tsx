...
const styles = StyleSheet.create({
  ...
  mantraChipActive: { backgroundColor: 'rgba(245, 158, 11, 0.35)', borderColor: '#F59E0B' },
  mantraChipText: { ...typography.tiny, color: '#EEF2FF', fontWeight: '700' },
  ...
  mantraSanskrit: { ...typography.body, color: '#FCD34D', fontWeight: '800', textAlign: 'center', lineHeight: 24 },
  mantraBenefit: { ...typography.tiny, color: '#A5B4FC', textAlign: 'center', fontStyle: 'italic' },
  ...
  statNum: { ...typography.h1, fontSize: 26, color: '#EEF2FF', fontWeight: '800' },
  statLabel: { ...typography.tiny, color: '#A5B4FC', marginTop: 2, textAlign: 'center' },
});
